...
export function PhoneIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg width="16" height="16" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
...
export function CodeIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg width="20" height="20" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
...
export function QuoteIcon({ className = "w-8 h-8" }: { className?: string }) {
  return (
    <svg width="34" height="34" className={className} viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
...
export function PlayIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg width="14" height="14" className={className} viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0 }}>
...
export function ChevronLeftIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg width="18" height="18" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
...
export function MenuIcon({ className = "w-6 h-6" }: { className?: string }) {
  return (
    <svg width="24" height="24" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
...
export function ArrowUpIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg width="16" height="16" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ flexShrink: 0 }}>
